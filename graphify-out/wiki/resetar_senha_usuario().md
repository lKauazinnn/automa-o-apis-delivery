...
> God node · 8 connections · [C:\Users\Gustavo\Desktop\automação ifood\server\app.py](file:///C:/Users/Gustavo/Desktop/automa%C3%A7%C3%A3o%20ifood/server/app.py#L899)

## Call Trace Diagram

```mermaid
sequenceDiagram
    participant P0 as resetar_senha_usuario()
    participant P1 as registrar_auditoria()
    participant P2 as _supabase_headers()
    participant P3 as convidar_usuario()
...
### rationale_for
- [[Define uma senha nova pra alguém direto pela Admin API do Supabase e devolve ela]] `EXTRACTED`
- [[Define uma senha nova pra alguém direto pela Admin API do Supabase e devolve ela]] `EXTRACTED`
