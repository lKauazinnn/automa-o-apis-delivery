...
- `auth_headers()` --calls--> `update_item_status()`  [INFERRED]
...
- `auth_headers()` --calls--> `update_item_price()`  [INFERRED]
  C:\Users\Gustavo\Desktop\automação ifood\src\ifood_automacao\auth.py → C:\Users\Gustavo\Desktop\automação ifood\src\ifood_automacao\client.py
...
Cohesion: 0.03
Nodes (33): ErroFatal, ACOES_DESPAUSAR, ACOES_PAUSAR, ALTURA_LINHA, ALTURA_MINIMA, DIAS_TENDENCIA, INTERVALO_EIXO_DIAS, MAX_ITENS_REINCIDENTES (+25 more)

### Community 2 - "Community 2"

Cohesion: 0.05
Nodes (63): auth_headers(), get_access_token(), Autenticação OAuth2 (client_credentials) com a Merchant API do iFood., Retorna um access token válido, reaproveitando o cache em memória enquanto não e, create_category(), create_combo(), create_interruption(), create_option() (+55 more)

### Community 3 - "Community 3"

Cohesion: 0.08
Nodes (56): Base, BaseModel, create_order(), gerar_codigo(), get_order(), list_orders(), Operações de banco: listagem com filtros/paginação, detalhe, criação, transição, Normaliza uma lista de enums/strings para os valores string usados no banco. (+48 more)
...
Cohesion: 0.06
Nodes (31): [ate, setAte], [carregando, setCarregando], [colsVisiveis, setColsVisiveis], COLUNAS, [colunasAbertas, setColunasAbertas], { conectado }, [data, setData], [de, setDe] (+23 more)

### Community 6 - "Community 6"

Cohesion: 0.08
Nodes (22): brl(), DetalhesPedidoModal(), PROXIMO_STATUS, STATUS_COR(), STATUS_LABEL, TIPO_LABEL, DetalhesPedidoModal(), INTERVALO_ATUALIZACAO_MS (+14 more)
...
Cohesion: 0.16
Nodes (9): App FastAPI: REST de pedidos + WebSocket para push em tempo real., Verificação/health que o portal do 99 pode fazer ao cadastrar o webhook., Recebe os eventos que o 99Food empurra. Responde errno:0 pra confirmar., _registrar_evento_99(), webhook_99food(), webhook_99food_check(), ws_endpoint(), ConnectionManager (+1 more)

### Community 11 - "Community 11"

Cohesion: 0.21
Nodes (14): caminho_relativo(), carregar_grafo(), classificar_tipo(), construir_mapa_nomes(), escrever_visual_obsidian(), gerar(), gerar_home(), nome_nota() (+6 more)
...
Cohesion: 0.43
Nodes (6): BASE, getOrder(), listOrders(), req(), transitionOrder(), WS_URL
