...
export const ACAO_LABEL = {
  ...
  criar_grupo_opcao: 'criou o grupo de complementos',
  excluir_grupo_opcao: 'excluiu o grupo de complementos',
  criar_opcao: 'criou o complemento',
  excluir_opcao: 'excluiu o complemento',
